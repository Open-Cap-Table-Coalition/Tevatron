...
| `isoQuantity` | [Decimal](decimal.md) | The total number of ISOs vested in this vesting event. | - |
...
| `nsoQuantity` | [Decimal](decimal.md) | The total number of NSOs vested in this vesting event. | - |
