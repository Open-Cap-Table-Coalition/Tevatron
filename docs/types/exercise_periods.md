...
| `deathExercisePeriod` | [Exercise Period](exercise_period.md) | The unit of time for the death exercise period. | - |
...
| `disabilityExercisePeriod` | [Exercise Period](exercise_period.md) | The unit of time for the disability exercise period. | - |
...
| `involuntaryTerminationCausePeriod` | [Exercise Period](exercise_period.md) | The unit of time for the involuntary termination cause period. | - |
...
| `involuntaryTerminationPeriod` | [Exercise Period](exercise_period.md) | The unit of time for the involuntary termination period. | - |
...
| `retirementExercisePeriod` | [Exercise Period](exercise_period.md) | The unit of time for the retirement exercise period. | - |
...
| `voluntaryTerminationPeriod` | [Exercise Period](exercise_period.md) | The unit of time for the voluntary termination period. | - |