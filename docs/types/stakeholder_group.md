...
**Description:** _A grouping of individual stakeholders used to compute capitalization calculations. All stakeholders within a group are considered when computing capitalization calculations.
...
| `optionPoolSummaries` | [`Array` of [Stakeholder Option Pool Summary](stakeholder_option_pool_summary.md)] | Per option pool summary information scoped to the stakeholder group. | - |
